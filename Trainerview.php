...
<body
    style="background-image: url(gymbackground.jpg); background-size:100%;  background-repeat: no-repeat; position:-webkit-sticky;">
    <div class="square">
        <a href="Traineredit.html" class="backbutton">&times;</a>
        <?php
        ...
        $result = mysqli_query($conn, $trainers);
